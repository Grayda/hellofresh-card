<div>
    <div class="container-fluid">
        <div class="row">
            <h1>How to use</h1>
            <ol>
                <li>If you haven't already, drag the bookmark called "Download Recipe" up to your bookmark bar</li>
                ...
                <li>You will be brought back to this page. Click on "<i class="bi-cloud-plus-fill"></i> Download"</li>
                <li>You'll see a green bar show up that says "Working..". When the bar disappears, the recipe has
        ...
        <div class="row">
            <div class="col-8">
                ...
                <div wire:loading class="alert alert-warning">
                    <i class="bi-cloud-arrow-down-fill"></i> Working..
                </div>
            </div>
