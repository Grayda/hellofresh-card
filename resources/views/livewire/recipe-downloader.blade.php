        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <ol>
                    ...
                    <li>You'll see a green bar show up that says "Downloading..". When the bar disappears, the recipe
                        has
                        finished downloading</li>
                    <li>Click on "<i class="bi-list"></i> Recipe List" to view it</li>
                    <li>If you want to search for all recipes at the same time, use this bookmark: <a
                            ...
                            Search Recipes</a>, then go to your "My Delivery" page on the HelloFresh website and click on the bookmark</li>
                </ol>
